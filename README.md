...
### ⚙️ Фреймворки
![FastAPI](https://img.shields.io/badge/FastAPI-282C34?logo=fastapi)
...
![Gin](https://img.shields.io/badge/Gin-282C34?logo=gin)
...
![MongoDB](https://img.shields.io/badge/MongoDB-282C34?logo=mongodb)
![Redis](https://img.shields.io/badge/Redis-282C34?logo=redis)

### 🧩 ORM и работа с БД
![SQLAlchemy](https://img.shields.io/badge/SQLAlchemy-282C34?logo=sqlalchemy)
![Alembic](https://img.shields.io/badge/Alembic-282C34)
![TypeORM](https://img.shields.io/badge/TypeORM-282C34?logo=typeorm)
![Knex](https://img.shields.io/badge/Knex-282C34?logo=knex)

### 📨 Брокеры сообщений и фоновые процессы
![Kafka](https://img.shields.io/badge/Kafka-282C34?logo=apachekafka)
![RabbitMQ](https://img.shields.io/badge/RabbitMQ-282C34?logo=rabbitmq)
![Celery](https://img.shields.io/badge/Celery-282C34?logo=celery)

### 🧪 Тестирование
![Pytest](https://img.shields.io/badge/Pytest-282C34?logo=pytest)
![Mocha](https://img.shields.io/badge/Mocha-282C34?logo=mocha)
